    ...
    public void onClick( View v) {
        switch (v.getId()) {
            case R.id.catID:
                ...
                catIntent.putExtra("name", "Midnight");
                catIntent.putExtra("bio", "Very Shy. Only comes out at night!");
            ...
            case R.id.dogId:
                ...
                dogIntent.putExtra("name", "Snowball");
                dogIntent.putExtra("bio", "Outgoing. Eats alot but unfortunately isn't potty trained!");
